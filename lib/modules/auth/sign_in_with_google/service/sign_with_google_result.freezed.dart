...
part of 'sign_with_google_result.dart';
...
/// @nodoc
mixin _$SignWithGoogleResult<T> {
  @optionalTypeArgs
...
/// @nodoc
abstract class $SignWithGoogleResultCopyWith<T, $Res> {
  factory $SignWithGoogleResultCopyWith(SignWithGoogleResult<T> value,
          $Res Function(SignWithGoogleResult<T>) then) =
      _$SignWithGoogleResultCopyWithImpl<T, $Res, SignWithGoogleResult<T>>;
}

/// @nodoc
class _$SignWithGoogleResultCopyWithImpl<T, $Res,
        $Val extends SignWithGoogleResult<T>>
    implements $SignWithGoogleResultCopyWith<T, $Res> {
  _$SignWithGoogleResultCopyWithImpl(this._value, this._then);
...
class __$$SucessImplCopyWithImpl<T, $Res>
    extends _$SignWithGoogleResultCopyWithImpl<T, $Res, _$SucessImpl<T>>
...
class _$SucessImpl<T> implements Sucess<T> {
  ...
  @override
  String toString() {
    return 'SignWithGoogleResult<$T>.success(data: $data)';
  }
...
abstract class Sucess<T> implements SignWithGoogleResult<T> {
...
class __$$FailureImplCopyWithImpl<T, $Res>
    extends _$SignWithGoogleResultCopyWithImpl<T, $Res, _$FailureImpl<T>>
...
class _$FailureImpl<T> implements Failure<T> {
  ...
  @override
  String toString() {
    return 'SignWithGoogleResult<$T>.failure(e: $e)';
  }
...
abstract class Failure<T> implements SignWithGoogleResult<T> {
