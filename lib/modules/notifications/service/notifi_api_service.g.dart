...
part of 'notifi_api_service.dart';
...
class _NotifiApiService implements NotifiApiService {
  _NotifiApiService(
    ...
    baseUrl ??= 'https://commuter-server-socket-io.onrender.com/notfy/';
  }
  ...
  Future<void> sendFcmToken(
    ...
    _data.addAll(sendFcmTokenRequestModel.toJson());
    await _dio.fetch<void>(_setStreamType<void>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
