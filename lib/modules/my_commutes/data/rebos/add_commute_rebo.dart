...
class AddCommuteRebo {
  ...
  Future<LocalStorageResult<void>> changePinCommute({
    required LocalCommuteModel localCommuteModel,
  }) async {
    try {
      await _localStorageService.changePinCommute(
          localCommuteModel: localCommuteModel);
      return const LocalStorageResult.success();
    } catch (e) {
      return LocalStorageResult.failure(error: e.toString());
  ...
  Future<LocalStorageResult<void>> deleteCommute({
    required LocalCommuteModel localCommuteModel,
  }) async {
    try {
      await _localStorageService.deleteCommute(
          localCommuteModel: localCommuteModel);
      return const LocalStorageResult.success();
    } catch (e) {
      return LocalStorageResult.failure(error: e.toString());
